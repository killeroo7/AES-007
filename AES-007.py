...
def get_args():
        ...
        parser.add_argument('--iv',dest='iv',help="16 bit IV",required=True)        
...
if args.plaintext:
	...
	encryptedMsg = encrypt(plaintext.encode(),key.encode(),iv.encode())
	...
	decryptedMsg = decrypt(ciphertext.encode(),key.encode(),iv.encode())
